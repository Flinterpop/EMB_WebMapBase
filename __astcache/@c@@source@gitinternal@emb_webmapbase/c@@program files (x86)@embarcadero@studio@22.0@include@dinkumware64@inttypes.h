...
_CRTIMP2 intmax_t imaxabs(intmax_t);
_CRTIMP2 imaxdiv_t imaxdiv(intmax_t, intmax_t);

_CRTIMP2 intmax_t strtoimax(const char *_Restrict,
	char **_Restrict, int);
_CRTIMP2 uintmax_t strtoumax(const char *_Restrict,
	char **_Restrict, int);
_CRTIMP2 intmax_t wcstoimax(const _Wchart *_Restrict,
	_Wchart **_Restrict, int);
_CRTIMP2 uintmax_t wcstoumax(const _Wchart *_Restrict,
	_Wchart **_Restrict, int);
_END_C_LIB_DECL
...
extern "C++" {
		// OVERLOADS, FOR C++
 #ifndef _LLDIV_T
#if !defined(__LLABSDIV) /* __CODEGEARC__ */
#define __LLABSDIV
